...
const CardNav: React.FC<CardNavProps> = ({
  ...
  return (
    <div className={`${styles.cardNavContainer} ${className}`}>
      <nav
        ref={navRef}
        className={`${styles.cardNav} ${isExpanded ? styles.open : ""}`}
      ...
      >
        ...
        <div className={styles.cardNavContent} aria-hidden={!isExpanded}>
            ...
            >
              ...
              <div className={styles.navCardLinks}>
                {item.links?.map((lnk, i) => (
                  ...
                  >
                    <GoArrowUpRight
                      className={styles.navCardLinkIcon}
                      aria-hidden="true"
                    />
                    {lnk.label}
                  </a>
